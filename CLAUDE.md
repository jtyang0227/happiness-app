...
│   ├── ProfileScreen.js     # bio/location/specialties/아바타업로드/통계 + "메뉴" 섹션(🤝 약속, 🌐 내 포트폴리오 보기 — Linking.openURL로 웹 포트폴리오 페이지를 시스템 브라우저에서 오픈, profileName 없으면 안내 Alert)
