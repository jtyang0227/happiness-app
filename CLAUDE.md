...
│   │   └── gatheringApi.js  # (신규, Feature 37) list/getMy/getDetail/respond/cancelParticipation/getFeed/getAlbum/getInstagramCandidates/shareToInstagram — 웹 gatheringApi.js의 부분집합(생성/수정/참여자관리/알림/앨범페이지 없음, 모바일 범위 축소)
│   ├── navigation/
