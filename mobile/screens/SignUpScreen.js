...
const styles = StyleSheet.create({
  ...
  sectionLabel:{ color: '#22D3EE', fontWeight: '700', fontSize: 12, letterSpacing: 1, marginBottom: 8, marginTop: 4 },
  ...
  atPrefix:        { backgroundColor: '#0f0f1e', borderWidth: 1, borderColor: '#374151',
                     ...
                     paddingHorizontal: 12, paddingVertical: 11, color: '#22D3EE', fontWeight: '700' },
  ...
  checkbox:    { width: 20, height: 20, borderRadius: 6, borderWidth: 1.5, borderColor: '#374151',
                 ...
                 flexShrink: 0 },
  checkboxChecked: { backgroundColor: '#E8121A', borderColor: '#E8121A' },
  checkmark:   { color: '#fff', fontSize: 12, fontWeight: '700' },
  checkLabel:  { color: '#9ca3af', fontSize: 12, flex: 1, lineHeight: 20 },
  checkLinkText: { color: '#22D3EE', textDecorationLine: 'underline' },
  btnPrimary:  { backgroundColor: '#E8121A', borderRadius: 12, paddingVertical: 14,
                 alignItems: 'center', marginBottom: 16 },
  btnText:     { color: '#fff', fontWeight: '700', fontSize: 16 },
  loginLink:   { alignItems: 'center' },
  loginLinkText:{ color: '#9ca3af', fontSize: 13 },
  loginLinkBold:{ color: '#22D3EE', fontWeight: '700' },
});
