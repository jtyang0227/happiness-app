...
@Table(name = "photos", indexes = {
    @Index(name = "idx_photos_member_created", columnList = "member_id, created_at"),
    @Index(name = "idx_photos_genre",          columnList = "genre"),
    @Index(name = "idx_photos_color_mood",     columnList = "color_mood")
})
@Data
@NoArgsConstructor
@AllArgsConstructor
