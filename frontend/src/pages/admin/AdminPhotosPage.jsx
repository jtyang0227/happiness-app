    ...
    <div ref={ref} style={{
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 10 }}>
        <button onClick={() => setSelected('')} style={{
          ...
          border: `1.5px solid ${!selected ? '#3182F6' : '#e5e5ed'}`,
          background: !selected ? '#E8F3FF' : '#fff',
          color: !selected ? '#3182F6' : '#9090b0', fontWeight: !selected ? 700 : 400,
        }}>미분류</button>
      ...
      <button
        ...
        style={{
          ...
          background: '#3182F6', color: '#fff', fontSize: 12, fontWeight: 700, cursor: 'pointer',
        }}
      >저장</button>
    </div>
  );
