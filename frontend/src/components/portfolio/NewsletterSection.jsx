  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse at center, rgba(49,130,246,0.08) 0%, transparent 70%)',
        padding: '48px 32px',
        borderRadius: 24,
        ...
        {status === 'success' ? (
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', gap: 8, flexWrap: 'wrap', justifyContent: 'center' }}>
            <input
              ...
              onFocus={e => { if (status !== 'error') e.target.style.borderColor = 'rgba(49,130,246,0.6)'; }}
