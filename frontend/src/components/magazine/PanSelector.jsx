const PAN_TYPES = [
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        <rect x="0" y="0" width="80" height="60" fill="#3182F6" opacity="0.8" />
  ...
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        <rect x="0" y="0" width="46" height="60" fill="#3182F6" opacity="0.8" />
  ...
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        <rect x="0" y="0" width="54" height="60" fill="#3182F6" opacity="0.8" />
        <rect x="55" y="0" width="25" height="60" fill="#ffffff" />
        <rect x="55" y="0" width="1" height="60" fill="#e2e2ee" />
        <circle cx="62" cy="10" r="5" fill="#E8F3FF" />
  ...
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        ...
        <rect x="2" y="8" width="23" height="42" rx="2" fill="#3182F6" opacity="0.7" />
        <rect x="28" y="8" width="23" height="42" rx="2" fill="#3182F6" opacity="0.85" />
        <rect x="54" y="8" width="23" height="42" rx="2" fill="#3182F6" opacity="0.7" />
      </svg>
    ),
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        <rect x="0" y="0" width="46" height="60" fill="#3182F6" opacity="0.8" />
        <rect x="48" y="0" width="32" height="18" rx="2" fill="#3182F6" opacity="0.6" />
        <rect x="48" y="21" width="32" height="18" rx="2" fill="#3182F6" opacity="0.6" />
        <rect x="48" y="42" width="32" height="18" rx="2" fill="#3182F6" opacity="0.6" />
      </svg>
    ),
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        <rect x="0" y="0" width="80" height="60" fill="#E8F3FF" />
        <rect x="20" y="4" width="40" height="52" rx="3" fill="#3182F6" opacity="0.8" />
      </svg>
    ),
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        ...
        <rect x="4" y="12" width="22" height="32" rx="2" fill="#3182F6" opacity="0.7" />
        <rect x="29" y="12" width="22" height="32" rx="2" fill="#3182F6" opacity="0.5" />
        <rect x="54" y="12" width="22" height="32" rx="2" fill="#3182F6" opacity="0.5" />
        {[0, 1, 2, 3, 4, 5, 6].map(i => (
  ...
  return (
    <div>
      <div style={{
        ...
        {selected && (
          <span style={{ fontSize: 12, color: '#3182F6' }}>
          ...
          return (
            <button
              ...
              style={{
                ...
                border: `2px solid ${isSelected ? '#3182F6' : '#e2e2ee'}`,
                background: isSelected ? '#E8F3FF' : '#fff',
                overflow: 'hidden', transition: 'all 0.15s',
                display: 'flex', flexDirection: 'column',
                boxShadow: isSelected ? '0 0 0 2px rgba(49,130,246,0.2)' : 'none',
              }}
            >
              ...
              <div style={{
                ...
                color: isSelected ? '#3182F6' : '#5c5c7a', textAlign: 'center',
              }}>
                {label}
              </div>
            </button>
