const PAN_TYPES = [
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        <rect x="0" y="0" width="80" height="60" fill="#E8121A" opacity="0.8" />
  ...
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        <rect x="0" y="0" width="46" height="60" fill="#E8121A" opacity="0.8" />
  ...
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        <rect x="0" y="0" width="54" height="60" fill="#E8121A" opacity="0.8" />
        <rect x="55" y="0" width="25" height="60" fill="#ffffff" />
        <rect x="55" y="0" width="1" height="60" fill="#e2e2ee" />
        <circle cx="62" cy="10" r="5" fill="#ffe9e7" />
  ...
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        ...
        <rect x="2" y="8" width="23" height="42" rx="2" fill="#E8121A" opacity="0.7" />
        <rect x="28" y="8" width="23" height="42" rx="2" fill="#E8121A" opacity="0.85" />
        <rect x="54" y="8" width="23" height="42" rx="2" fill="#E8121A" opacity="0.7" />
      </svg>
    ),
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        <rect x="0" y="0" width="46" height="60" fill="#E8121A" opacity="0.8" />
        <rect x="48" y="0" width="32" height="18" rx="2" fill="#E8121A" opacity="0.6" />
        <rect x="48" y="21" width="32" height="18" rx="2" fill="#E8121A" opacity="0.6" />
        <rect x="48" y="42" width="32" height="18" rx="2" fill="#E8121A" opacity="0.6" />
      </svg>
    ),
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        <rect x="0" y="0" width="80" height="60" fill="#ffe9e7" />
        <rect x="20" y="4" width="40" height="52" rx="3" fill="#E8121A" opacity="0.8" />
      </svg>
    ),
  },
  {
    ...
    preview: (
      <svg viewBox="0 0 80 60" style={{ width: '100%', height: '100%' }}>
        ...
        <rect x="4" y="12" width="22" height="32" rx="2" fill="#E8121A" opacity="0.7" />
        <rect x="29" y="12" width="22" height="32" rx="2" fill="#E8121A" opacity="0.5" />
        <rect x="54" y="12" width="22" height="32" rx="2" fill="#E8121A" opacity="0.5" />
        {[0, 1, 2, 3, 4, 5, 6].map(i => (
  ...
  return (
    <div>
      <div style={{
        ...
        {selected && (
          <span style={{ fontSize: 12, color: '#E8121A' }}>
          ...
          return (
            <button
              ...
              style={{
                ...
                border: `2px solid ${isSelected ? '#E8121A' : '#e2e2ee'}`,
            ...
            >
              ...
              <div style={{
                ...
                color: isSelected ? '#E8121A' : '#5c5c7a', textAlign: 'center',
              }}>
                {label}
              </div>
            </button>
